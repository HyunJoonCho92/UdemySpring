...
public class MemberController {
	...
	@GetMapping("/register")
	String insertMember() {
		return "member/register"; //member/register.jsp (7개의 데이터폼)
	}
	
	@PostMapping("/register")
	ModelAndView insertMember2(@ModelAttribute("dto") MemberDTO dto) {
//		1. dto 입력 id pw이 spring/1111 인지 검사
//		2-1. 맞으면 이전 가입된 적이 있습니다. spring 회원님은 정상 로그인되셨습니다.
//		2-2. 아니면 dto 모든 변수값 출력. 회원가입되셨습니다.
